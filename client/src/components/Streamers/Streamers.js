...
const Streamers = (props) => {
    let { user, streamers, width, dateDifference, showLogin, showSearch, loading } = props;

    if (!user) {
        return (
            <div className="followed">
                <div className="unauth">
                    <FontAwesomeIcon className="icon" icon="user-circle" size="8x" />
    ...
    if (!streamers.length) {
        return (
            <div className="followed">
                <div className="unauth">
                    <FontAwesomeIcon className="icon" icon="user-plus" size="8x" />
    ...
    return (
        <div className="followed">
            <div className="streamers">
                ...
                <StreamerList streamers={streamers} dateDifference={dateDifference} width={width}></StreamerList>
            </div>
        </div>
    );
};
